...
-- map("n", "<leader>bd", require("config.utils.ui").bufremove, { desc = "Delete Buffer" })
...
map("n", "<leader>uL", function() require("config.utils.toggle").relativenumber() end, { desc = "Toggle Relative Line Numbers" })
map("n", "<leader>ul", function() require("config.utils.toggle").number() end, { desc = "Toggle Line Numbers" })
...
map("n", "<leader><tab>qa", "<cmd>tabonly<cr>", { desc = "Close Other Tabs" })
