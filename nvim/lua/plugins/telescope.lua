return {
  {
    ...
    keys = {
      ...
      { "<leader>fc", "<cmd>Telescope files<cr>", desc = "Find Config File" },
      ...
      { "<leader>sW", "<cmd>Telescope grep_string<cr>", mode = "v", desc = "Selection (Root Dir)" },
      { "<leader>uC", "<cmd>Telescope colorscheme enable_preview=true ignore_builtins=true<cr>", desc = "Colorscheme with Preview" },
      {
        "<leader>ss",
        function()
